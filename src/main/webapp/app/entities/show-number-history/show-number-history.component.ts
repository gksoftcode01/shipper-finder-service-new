  ...
  setup() {
    ...
    const retrieveShowNumberHistorys = async () => {
      ...
      try {
        ...
        const res = await showNumberHistoryService().retrieve(paginationQuery);
    ...
    const removeShowNumberHistory = async () => {
      try {
        ...
        const message = t$('shipperFinderApp.showNumberHistory.deleted', { param: removeId.value }).toString();
