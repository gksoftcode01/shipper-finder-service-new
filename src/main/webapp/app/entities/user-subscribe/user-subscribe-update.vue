  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperFinderApp.userSubscribe.home.createOrEditLabel"
          data-cy="UserSubscribeCreateUpdateHeading"
          v-text="t$('shipperFinderApp.userSubscribe.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.userSubscribe.fromDate')" for="user-subscribe-fromDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.userSubscribe.toDate')" for="user-subscribe-toDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.userSubscribe.isActive')" for="user-subscribe-isActive"></label>
            <input
              type="checkbox"
              class="form-check"
              name="isActive"
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('shipperFinderApp.userSubscribe.subscribedUserEncId')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperFinderApp.userSubscribe.subscribeType')"
