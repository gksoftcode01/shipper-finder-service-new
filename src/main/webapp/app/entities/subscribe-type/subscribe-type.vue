<template>
  <div>
    <h2 id="page-heading" data-cy="SubscribeTypeHeading">
      <span v-text="t$('shipperFinderApp.subscribeType.home.title')" id="subscribe-type-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperFinderApp.subscribeType.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'SubscribeTypeCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperFinderApp.subscribeType.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && subscribeTypes && subscribeTypes.length === 0">
      <span v-text="t$('shipperFinderApp.subscribeType.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="subscribeTypes">
        ...
        <tbody>
          <tr v-for="subscribeType in subscribeTypes" :key="subscribeType.id" data-cy="entityTable">
            ...
            <td v-text="t$('shipperFinderApp.SubscribeTypeEnum.' + subscribeType.type)"></td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperFinderApp.subscribeType.delete.question"
          data-cy="subscribeTypeDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-subscribeType-heading" v-text="t$('shipperFinderApp.subscribeType.delete.question', { id: removeId })"></p>
      </div>
