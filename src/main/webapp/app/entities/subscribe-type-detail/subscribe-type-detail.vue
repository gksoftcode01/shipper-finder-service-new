<template>
  <div>
    <h2 id="page-heading" data-cy="SubscribeTypeDetailHeading">
      <span v-text="t$('shipperFinderApp.subscribeTypeDetail.home.title')" id="subscribe-type-detail-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperFinderApp.subscribeTypeDetail.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'SubscribeTypeDetailCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperFinderApp.subscribeTypeDetail.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && subscribeTypeDetails && subscribeTypeDetails.length === 0">
      <span v-text="t$('shipperFinderApp.subscribeTypeDetail.home.notFound')"></span>
    </div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperFinderApp.subscribeTypeDetail.delete.question"
      ...
      <div class="modal-body">
        <p
          ...
          v-text="t$('shipperFinderApp.subscribeTypeDetail.delete.question', { id: removeId })"
        ></p>
      </div>
