<template>
  <div>
    <h2 id="page-heading" data-cy="StateProvinceHeading">
      <span v-text="t$('shipperFinderApp.stateProvince.home.title')" id="state-province-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperFinderApp.stateProvince.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'StateProvinceCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperFinderApp.stateProvince.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && stateProvinces && stateProvinces.length === 0">
      <span v-text="t$('shipperFinderApp.stateProvince.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('name')">
              <span v-text="t$('shipperFinderApp.stateProvince.name')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('localName')">
              <span v-text="t$('shipperFinderApp.stateProvince.localName')"></span>
            ...
            <th scope="row" @click="changeOrder('isoCode')">
              <span v-text="t$('shipperFinderApp.stateProvince.isoCode')"></span>
            ...
            <th scope="row" @click="changeOrder('country.name')">
              <span v-text="t$('shipperFinderApp.stateProvince.country')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperFinderApp.stateProvince.delete.question"
          data-cy="stateProvinceDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-stateProvince-heading" v-text="t$('shipperFinderApp.stateProvince.delete.question', { id: removeId })"></p>
      </div>
