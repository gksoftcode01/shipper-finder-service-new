  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperFinderApp.cargoRequest.home.createOrEditLabel"
          data-cy="CargoRequestCreateUpdateHeading"
          v-text="t$('shipperFinderApp.cargoRequest.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('shipperFinderApp.cargoRequest.createDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperFinderApp.cargoRequest.validUntil')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.cargoRequest.status')" for="cargo-request-status"></label>
            <select
              class="form-control"
              name="status"
            ...
            >
              <option
                ...
                :label="t$('shipperFinderApp.CargoRequestStatus.' + cargoRequestStatus)"
              >
                {{ cargoRequestStatus }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperFinderApp.cargoRequest.isNegotiable')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.cargoRequest.budget')" for="cargo-request-budget"></label>
            <input
              type="number"
              class="form-control"
              name="budget"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperFinderApp.cargoRequest.createdByEncId')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperFinderApp.cargoRequest.takenByEncId')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.cargoRequest.encId')" for="cargo-request-encId"></label>
            <input
              type="text"
              class="form-control"
              name="encId"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperFinderApp.cargoRequest.fromCountry')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.cargoRequest.toCountry')" for="cargo-request-toCountry"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.cargoRequest.fromState')" for="cargo-request-fromState"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.cargoRequest.toState')" for="cargo-request-toState"></label>
