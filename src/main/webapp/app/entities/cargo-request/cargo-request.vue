<template>
  <div>
    <h2 id="page-heading" data-cy="CargoRequestHeading">
      <span v-text="t$('shipperFinderApp.cargoRequest.home.title')" id="cargo-request-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperFinderApp.cargoRequest.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'CargoRequestCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperFinderApp.cargoRequest.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && cargoRequests && cargoRequests.length === 0">
      <span v-text="t$('shipperFinderApp.cargoRequest.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="cargoRequests">
        ...
        <tbody>
          <tr v-for="cargoRequest in cargoRequests" :key="cargoRequest.id" data-cy="entityTable">
            ...
            <td v-text="t$('shipperFinderApp.CargoRequestStatus.' + cargoRequest.status)"></td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperFinderApp.cargoRequest.delete.question"
          data-cy="cargoRequestDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-cargoRequest-heading" v-text="t$('shipperFinderApp.cargoRequest.delete.question', { id: removeId })"></p>
      </div>
