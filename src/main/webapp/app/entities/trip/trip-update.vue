  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperFinderApp.trip.home.createOrEditLabel"
          data-cy="TripCreateUpdateHeading"
          v-text="t$('shipperFinderApp.trip.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.tripDate')" for="trip-tripDate"></label>
            <div class="d-flex">
              <input
                id="trip-tripDate"
                data-cy="tripDate"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.arriveDate')" for="trip-arriveDate"></label>
            <div class="d-flex">
              <input
                id="trip-arriveDate"
                data-cy="arriveDate"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.maxWeight')" for="trip-maxWeight"></label>
            <input
              type="number"
              class="form-control"
              name="maxWeight"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.notes')" for="trip-notes"></label>
            <input
              type="text"
              class="form-control"
              name="notes"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.createDate')" for="trip-createDate"></label>
            <div class="d-flex">
              <input
                id="trip-createDate"
                data-cy="createDate"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.isNegotiate')" for="trip-isNegotiate"></label>
            <input
              type="checkbox"
              class="form-check"
              name="isNegotiate"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.status')" for="trip-status"></label>
            <select
              class="form-control"
              name="status"
            ...
            >
              <option
                ...
                :key="tripStatus"
                :value="tripStatus"
                :label="t$('shipperFinderApp.TripStatus.' + tripStatus)"
              >
                {{ tripStatus }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.createdByEncId')" for="trip-createdByEncId"></label>
            <input
              type="text"
              class="form-control"
              name="createdByEncId"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.encId')" for="trip-encId"></label>
            <input
              type="text"
              class="form-control"
              name="encId"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.fromCountry')" for="trip-fromCountry"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.toCountry')" for="trip-toCountry"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.fromState')" for="trip-fromState"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.trip.toState')" for="trip-toState"></label>
