  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperFinderApp.cargoRequestItem.home.createOrEditLabel"
          data-cy="CargoRequestItemCreateUpdateHeading"
          v-text="t$('shipperFinderApp.cargoRequestItem.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('shipperFinderApp.cargoRequestItem.maxQty')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperFinderApp.cargoRequestItem.photoUrl')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.cargoRequestItem.item')" for="cargo-request-item-item"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.cargoRequestItem.unit')" for="cargo-request-item-unit"></label>
          ...
          <div class="form-group">
            <label v-text="t$('shipperFinderApp.cargoRequestItem.tag')" for="cargo-request-item-tag"></label>
            <select
              class="form-control"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperFinderApp.cargoRequestItem.cargoRequest')"
