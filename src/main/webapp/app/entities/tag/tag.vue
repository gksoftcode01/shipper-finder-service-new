<template>
  <div>
    <h2 id="page-heading" data-cy="TagHeading">
      <span v-text="t$('shipperFinderApp.tag.home.title')" id="tag-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperFinderApp.tag.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'TagCreate' }" custom v-slot="{ navigate }">
          <button @click="navigate" id="jh-create-entity" data-cy="entityCreateButton" class="btn btn-primary jh-create-entity create-tag">
            ...
            <span v-text="t$('shipperFinderApp.tag.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && tags && tags.length === 0">
      <span v-text="t$('shipperFinderApp.tag.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('name')">
              <span v-text="t$('shipperFinderApp.tag.name')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('nameEn')">
              <span v-text="t$('shipperFinderApp.tag.nameEn')"></span>
            ...
            <th scope="row" @click="changeOrder('nameAr')">
              <span v-text="t$('shipperFinderApp.tag.nameAr')"></span>
            ...
            <th scope="row" @click="changeOrder('nameFr')">
              <span v-text="t$('shipperFinderApp.tag.nameFr')"></span>
            ...
            <th scope="row" @click="changeOrder('nameDe')">
              <span v-text="t$('shipperFinderApp.tag.nameDe')"></span>
            ...
            <th scope="row" @click="changeOrder('nameUrdu')">
              <span v-text="t$('shipperFinderApp.tag.nameUrdu')"></span>
            ...
            <th scope="row" @click="changeOrder('iconUrl')">
              <span v-text="t$('shipperFinderApp.tag.iconUrl')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="shipperFinderApp.tag.delete.question" data-cy="tagDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-tag-heading" v-text="t$('shipperFinderApp.tag.delete.question', { id: removeId })"></p>
      </div>
