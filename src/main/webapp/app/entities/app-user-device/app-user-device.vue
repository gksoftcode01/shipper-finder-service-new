<template>
  <div>
    <h2 id="page-heading" data-cy="AppUserDeviceHeading">
      <span v-text="t$('shipperFinderApp.appUserDevice.home.title')" id="app-user-device-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperFinderApp.appUserDevice.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'AppUserDeviceCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperFinderApp.appUserDevice.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && appUserDevices && appUserDevices.length === 0">
      <span v-text="t$('shipperFinderApp.appUserDevice.home.notFound')"></span>
    </div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperFinderApp.appUserDevice.delete.question"
          data-cy="appUserDeviceDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-appUserDevice-heading" v-text="t$('shipperFinderApp.appUserDevice.delete.question', { id: removeId })"></p>
      </div>
