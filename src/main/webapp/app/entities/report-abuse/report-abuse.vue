<template>
  <div>
    <h2 id="page-heading" data-cy="ReportAbuseHeading">
      <span v-text="t$('shipperFinderApp.reportAbuse.home.title')" id="report-abuse-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperFinderApp.reportAbuse.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ReportAbuseCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperFinderApp.reportAbuse.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && reportAbuses && reportAbuses.length === 0">
      <span v-text="t$('shipperFinderApp.reportAbuse.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="reportAbuses">
        ...
        <tbody>
          <tr v-for="reportAbuse in reportAbuses" :key="reportAbuse.id" data-cy="entityTable">
            ...
            <td v-text="t$('shipperFinderApp.ReportStatus.' + reportAbuse.reportStatus)"></td>
            <td class="text-right">
              <div class="btn-group">
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperFinderApp.reportAbuse.delete.question"
          data-cy="reportAbuseDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-reportAbuse-heading" v-text="t$('shipperFinderApp.reportAbuse.delete.question', { id: removeId })"></p>
      </div>
