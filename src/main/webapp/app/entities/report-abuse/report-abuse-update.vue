  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperFinderApp.reportAbuse.home.createOrEditLabel"
          data-cy="ReportAbuseCreateUpdateHeading"
          v-text="t$('shipperFinderApp.reportAbuse.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('shipperFinderApp.reportAbuse.reportByEncId')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperFinderApp.reportAbuse.reportedAgainstEncId')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.reportAbuse.reportDate')" for="report-abuse-reportDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.reportAbuse.reportData')" for="report-abuse-reportData"></label>
            <input
              type="text"
              class="form-control"
              name="reportData"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperFinderApp.reportAbuse.reportStatus')"
            ...
            >
              <option
                ...
                :key="reportStatus"
                :value="reportStatus"
                :label="t$('shipperFinderApp.ReportStatus.' + reportStatus)"
              >
                {{ reportStatus }}
              </option>
            </select>
