  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperFinderApp.appUser.home.createOrEditLabel"
          data-cy="AppUserCreateUpdateHeading"
          v-text="t$('shipperFinderApp.appUser.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.birthDate')" for="app-user-birthDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.gender')" for="app-user-gender"></label>
            <select
              class="form-control"
              name="gender"
            ...
            >
              <option
                ...
                :key="genderType"
                :value="genderType"
                :label="t$('shipperFinderApp.GenderType.' + genderType)"
              >
                {{ genderType }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.registerDate')" for="app-user-registerDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.phoneNumber')" for="app-user-phoneNumber"></label>
            <input
              type="text"
              class="form-control"
              name="phoneNumber"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.mobileNumber')" for="app-user-mobileNumber"></label>
            <input
              type="text"
              class="form-control"
              name="mobileNumber"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.fullName')" for="app-user-fullName"></label>
            <input
              type="text"
              class="form-control"
              name="fullName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.isVerified')" for="app-user-isVerified"></label>
            <input
              type="checkbox"
              class="form-check"
              name="isVerified"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.userId')" for="app-user-userId"></label>
            <input
              type="number"
              class="form-control"
              name="userId"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.firstName')" for="app-user-firstName"></label>
            <input
              type="text"
              class="form-control"
              name="firstName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.lastName')" for="app-user-lastName"></label>
            <input
              type="text"
              class="form-control"
              name="lastName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.encId')" for="app-user-encId"></label>
            <input
              type="text"
              class="form-control"
              name="encId"
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('shipperFinderApp.appUser.preferdLanguage')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.appUser.location')" for="app-user-location"></label>
