<template>
  <div>
    <h2 id="page-heading" data-cy="AppUserHeading">
      <span v-text="t$('shipperFinderApp.appUser.home.title')" id="app-user-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperFinderApp.appUser.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'AppUserCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperFinderApp.appUser.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && appUsers && appUsers.length === 0">
      <span v-text="t$('shipperFinderApp.appUser.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="appUsers">
        ...
        <tbody>
          <tr v-for="appUser in appUsers" :key="appUser.id" data-cy="entityTable">
            ...
            <td v-text="t$('shipperFinderApp.GenderType.' + appUser.gender)"></td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="shipperFinderApp.appUser.delete.question" data-cy="appUserDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-appUser-heading" v-text="t$('shipperFinderApp.appUser.delete.question', { id: removeId })"></p>
      </div>
