  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperFinderApp.tripItem.home.createOrEditLabel"
          data-cy="TripItemCreateUpdateHeading"
          v-text="t$('shipperFinderApp.tripItem.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.tripItem.itemPrice')" for="trip-item-itemPrice"></label>
            <input
              type="number"
              class="form-control"
              name="itemPrice"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.tripItem.maxQty')" for="trip-item-maxQty"></label>
            <input
              type="number"
              class="form-control"
              name="maxQty"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.tripItem.item')" for="trip-item-item"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.tripItem.unit')" for="trip-item-unit"></label>
          ...
          <div class="form-group">
            <label v-text="t$('shipperFinderApp.tripItem.tag')" for="trip-item-tag"></label>
            <select
              class="form-control"
              id="trip-item-tags"
              data-cy="tag"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperFinderApp.tripItem.trip')" for="trip-item-trip"></label>
